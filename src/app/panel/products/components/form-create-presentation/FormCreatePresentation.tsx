...
interface FormCreatePresentationProps {
	onSubmit: (data: any) => void;
}

const FormCreatePresentation = ({ onSubmit }: FormCreatePresentationProps) => {
	const { options, selected, addOption, setSelected } = useLabelsStore();
	const {
		handleSubmit,
		control,
		formState: { errors },
...
export default FormCreatePresentation;
